...
The current source release is `v0.10.0`. It is production-validated for Emby live playback and successfully brokers playback for Emby and Channels DVR; its generated outputs have also been exercised with Jellyfin, VLC, and Kodi.
